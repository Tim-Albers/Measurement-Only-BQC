...
if __name__ == "__main__":
    ...
    num_runs = 2000 #20000  #18444 #73777 # Times the simulation is repeated - determines confidence interval of average outcome based on Hoeffding's bound
    run_amount = 500 #10000 # The simulation is run in batches of run_amount to limit memory usage
