...
steady_param_yaml = "/home/tim/Desktop/Desktop/DELFT/BEP/CODE/measurement-only-bqc/steady_params.yaml" # Path to yaml file containing the paramters that are not varied over
...
def main():
    ...
    if args.opt_params:
        ...
        baseline_yaml = "/home/janice/Documents/baseline.yaml"
